...
def control_user_input_integer(prompt, min_value=None, max_value=None):
...
def control_user_input_float(prompt, min_value=None, max_value=None):
...
def main():
    ...
    try:
        ...
        selected_vehicle_number = control_user_input_integer("Wählen Sie ein Fahrzeug durch Eingabe der entsprechenden Nummer", 1, len(vehicles))
        ...
        selected_weather_number = control_user_input_integer("Wählen Sie ein Wetter durch Eingabe der entsprechenden Nummer", 1, len(weathers))
        ...
        selected_route_number = control_user_input_integer("Wählen Sie eine Route durch Eingabe der entsprechenden Nummer", 1, len(routes))
        trip_config.select_route(routes, selected_route_number)
        print(f"Gewählte Route: {trip_config.route.name}\n")
        
        #Batteriestand eingeben
        print("=== Batteriestand ===")
        capacity_percent = control_user_input_float("Geben Sie den aktuellen Batteriestand in Prozent ein", 0,100)
